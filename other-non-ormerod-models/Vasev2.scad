//Vase Shape
shape = "star"; // [polygon, ellipse, star]
...
//Offset adds edge rounding or bevel
offset_type = "bevel"; // [bevel, round ,miter]

//rounding radius or bevel amount
offset_delta = 10;
...
module vase(base, base2, top, height, twist, scale, slices, shape, sides){
	linear_extrude(
		...
		if (shape == "polygon") {
			...
			offset(delta = offset_delta, join_type = offset_type) {
